<template>
    <div class="sk_test">
        ...
        <!-- Emotion Field Start -->
        <div class="input"  v-if="type == 'spending'">
            <label>How did you feel while spending?</label>
            <select v-model="emotion">
                <option disabled value="">Select an emotion</option>
            ...
            <validation-error v-if="errors.emotion" :message="errors.emotion"></validation-error>
        </div>
        <!-- Emotion Field End -->
        ...
        <div v-if="success" class="mt-2" style="color: green;">
            ...
            if (!this.loading) {
                ...
                if (this.isRecurring) {
                    ...
                    let body = {
                        ...
                        currency_id: this.selectedCurrencyId,
                        amount: this.amount,
                        emotion: this.emotion // <-- New Added
                    }
