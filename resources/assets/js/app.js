...
import TransactionWizardTwo from './components/TransactionWizardTwo.vue';
...
Vue.component('transaction-wizard-two', TransactionWizardTwo);
Vue.component('validation-error', ValidationError);
Vue.component('searchable', Searchable);
Vue.component('color-picker', ColorPicker); 
Vue.component('emotion-chart', EmotionChart);
